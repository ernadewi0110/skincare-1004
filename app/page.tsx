  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        <img
          src="/madagascar-landscape-with-mountains-and-nature.jpg"
        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          {["Ampoule", "Toner", "Cream", "Ingredients", "Skin IQ"].map((category) => (
            <Link key={category} href="/shop" className="flex-shrink-0">
              <div className="w-24 h-24 rounded-full bg-muted flex items-center justify-center text-sm font-medium hover:bg-primary hover:text-primary-foreground transition-colors">
                {category}
              </div>
            </Link>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              Experience the pure essence of Madagascar with our signature Centella Ampoule. This lightweight serum
              soothes, hydrates, and strengthens your skin barrier.
            </p>
            <Link href="/shop/1">
